...
function CargarProducto() {
  console.log("CargarProducto component mounted");
        ...
        preConfirm: async () => {
          try {
            ...
            if (response.ok) {
              ...
              Swal.fire({
                position: "top-end",
                text: "El tamaño que desea enviar es mayor al soportado",
                icon: "error",
            ...
            // Habilitar el botón de envío después de completar la lógica
